            ...
            if os.path.isdir('/sys'):
                ...
                if len(display_port_names) > 0:
                    if len(str(display_port_names[0])) > 2:
                        ...
                        if self.DEBUG:
                            print("power-settings debug: self.display1_width: " + str(self.display1_width))
                ...
                if self.DEBUG:
                    print("power-settings debug: self.display_port1_name: " + str(self.display_port1_name))
                    print("power-settings debug: self.display_port2_name: " + str(self.display_port2_name))
        ...
        try:
            if os.path.isdir('/sys'):
                if len(str(hdmi_port_name)) > 2:
                    ...
                    if self.DEBUG:
                        print("power-settings debug: connected_check: " + str(connected_check))
                    if connected_check != None and len(str(connected_check)) > 5 and '+' in str(connected_check):
                        ...
                        if self.DEBUG:
                            print("power-settings debug: stripped connected_check: " + str(connected_check))
                        if 'x' in connected_check:
                            ...
                            if connected_check_parts[0] == str(int(connected_check_parts[0])) and connected_check_parts[1] == str(int(connected_check_parts[1])):
                                if self.DEBUG:
                                    print("power-settings debug: resolution: " + str(connected_check_parts))
    ...
    def backup(self):
        ...
        try:
            ...
            if len(self.backup_file_path) > 10:
                ...
                touch_all_data_folder_command = touch_all_data_folder_command + " \\"
                touch_all_data_folder_command = touch_all_data_folder_command + ';'
                if self.DEBUG:
